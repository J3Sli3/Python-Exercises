...
# NEXT I will proceed with a list named 'words' containing lots of english words, now usually I would create a another python file with the 'words' list within it, and import the list to this Hangman game file, but for simplicity in Github I will directly put the 'words' list within the Hangman game file.#
